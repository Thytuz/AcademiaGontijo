    ...
    for (var ident1 = 0; ident1 < tamanhoDestino; ident1++) {
        ...
        ajax.done(function (resposta) {
            ...
            for (var ident2 = 0; ident2 < linhas.length; ident2++) {
                ...
                /**
                 * @author Prof. Victor
                 * o if abaixo foi implementado para retirar qualquer caracter especial que vier pelo AJAX
                 */
                if (/[\n|\n\r]/.test(value)) {
                    value = value.replace(/(\r\n|\n|\r)/gm, "");
                }
...
//esta função serve para executar dois metodos no onchange do select onde a metade dos primeiros parametros executa o metodo montaOptionParaCombo e a segunda metade executa montaOptionParaCombos 
function montaMultiplosComboComSegundoMultiplo(identificadoresDosCombosDeOrigem1, comboDestino1, objeto1, metodo1, parametrosExtras1, identificadoresDosCombosDeOrigem2,
        identificadoresDosCombosDeDestino2, objetos2, metodos2, parametrosExtras2) {


    setTimeout(function () {
        montaOptionsParaCombo(identificadoresDosCombosDeOrigem1, comboDestino1, objeto1, metodo1, parametrosExtras1);

    }, 100);
    montaOptionsParaCombos(identificadoresDosCombosDeOrigem2, identificadoresDosCombosDeDestino2, objetos2, metodos2, parametrosExtras2);
