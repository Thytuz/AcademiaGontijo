...
function montaOptionsParaCombo(identificadoresDosCombosDeOrigem, comboDestino, objeto, metodo, parametrosExtras) {
    ...
    if (typeof (parametrosExtras) == "undefined") {
        //não precisa fazer nada quando os parâmetros extras vierem vazios
    } else {
        if (parametrosExtras == '') {
            //não precisa fazer nada quando os parâmetros extras vierem vazios
        } else {
            if (typeof (parametrosExtras) == "string") {
                //se eh string eh so continuar
            } else {
                //se nao eh string, transforma para string
                parametrosExtras = String(parametrosExtras);
            }
